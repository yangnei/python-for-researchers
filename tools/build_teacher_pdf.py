...
COVER = f"""
<div class="cover">
  <div class="sub">Python for an Education Researcher</div>
  ...
  <div class="meta">
     A 9-session (8–10 hour) accelerated Python course, adapted from CS50P<br>
...
<title>Teacher Edition — Python for an Education Researcher</title>
